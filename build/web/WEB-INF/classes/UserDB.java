...
// This class handles the USER table.
    ...
    public User addUser(User user) {
        ...
        // insert the new row into the table
        try {
            ps = connection.prepareStatement("INSERT INTO user(LastName, FirstName, Email, Address1, Address2, City, State, Postalcode, Country) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public User getUser(String userID) {
        ...
        return new User(firstName, lastName, email, address1, address2, city, state, zipcode, country);
    }
